  ...
  return (
    <div className="max-w-6xl p-4 mx-auto">
      ...
      <div className="flex flex-col min-h-[60vh] gap-4 justify-center items-center mt-8">
        ...
        <p className="text-slate-700 text-center text-lg max-w-2xl">
        ...
        <button
          ...
          className="bg-emerald-400 text-slate-100 px-6 py-2 border border-slate-300 self-center rounded-xl font-semibold cursor-pointer text-lg shadow hover:bg-emerald-500 transition-all duration-200"
        >
          Try Demo
        </button>
      </div>
      ...
      <section className="mt-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="font-bold mb-1">1. Enter Details</h3>
            <p>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="font-bold mb-1">2. Generate Letter</h3>
            <p>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="font-bold mb-1">3. Save & Use</h3>
            <p>
      ...
      <section className="mt-20">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="flex flex-col items-center text-center">
            ...
            <p>Generates cover letters and cold emails using advanced AI.</p>
          </div>
          <div className="flex flex-col items-center text-center">
            <div className="bg-slate-100 text-slate-500 rounded-xl px-3 py-2 mb-2 text-3xl">
              <i className="ri-user-settings-line"></i>
            </div>
            <h3 className="font-bold mb-1">Personalized</h3>
            <p>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="font-bold mb-1">History & Management</h3>
            <p>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="font-bold mb-1">Edit & Copy</h3>
            <p>
      ...
      <section className="mt-20 mb-16">
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          <div>
            <h3 className="font-bold">Is this free to use?</h3>
            <p>Yes, you can generate and manage cover letters for free.</p>
          </div>
          <div>
            <h3 className="font-bold">Can I edit the generated letter?</h3>
            <p>
          ...
          <div>
            <h3 className="font-bold">How many results can I save?</h3>
            <p>
